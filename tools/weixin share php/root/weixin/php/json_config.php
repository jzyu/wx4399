...
class JSSDK {
  ...
  private function getAccessToken() {
    ...
    if ($data->expire_time < time()) {
      //可将下面的URL换成自己缓存的URL，但返回格式保持微信一致。
...
//请修改下面两参数，定制第二个页
$signPackage['image'] = 'http://osgames1.b0.upaiyun.com/games/jzyu/cjcard/abd/aibeiduo.png';
$signPackage['link']  = 'http://mp.weixin.qq.com/s?__biz=MzA3ODIyOTMzOA==&mid=203771065&idx=1&sn=7b9b42c4db29d6a1154382401547f708#rd'; 
